...
The **Basemap** section under Sources offers several satellite/hybrid basemaps (Google Hybrid, Bing Aerial, ESRI World Imagery, Mapbox Satellite, HERE Satellite, Google Satellite, OpenStreetMap) plus any custom source you've added — see [Bring Your Own Data](/features/byod).
...
- **ESRI Wayback** — dated releases of ESRI World Imagery
- **HLS** (Harmonized Landsat/Sentinel-2) — monthly, coarser resolution
- **Google Earth Historical** — occasional very old outlier captures for well-covered areas
- **Planet Monthly Mosaic** — requires an API key
