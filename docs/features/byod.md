...
- **XYZ Terrarium or Terrain-RGB** tiles (a raw tile URL template)
...
For non-georeferenced data (e.g. frescoes, artifact scans), see the dedicated [Non-Geo Relief Visualization guide](https://github.com/Iconem/elevation-terrain-visualizer/blob/main/Non-Geo-Relief-Visualization.md) for the COG parameters needed to avoid artifacts.
